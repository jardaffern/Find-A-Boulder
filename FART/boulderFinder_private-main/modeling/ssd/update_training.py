'''
This script is intended to be used after training has been done.

If we have a trained model we can do transfer learning (I think thats the term)
to continue to train with some updated labels.
