'''
This is the training script for images currently.
...
#------------------------------------------------------------------------------------------------
train_loader = DataLoader(train_ds_total, batch_size=2, collate_fn=train_ds.collate_fn, drop_last=True, shuffle=True)
