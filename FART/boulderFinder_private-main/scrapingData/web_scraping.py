'''
This script scrapes from a set of urls from MP for lat/long.
Note that many parts of this are hardcoded to the MP website 'layout'.
...
def grabURL(urlToStart):
    ...
    rawHTML = session.get(urlToStart).text
...
'https://www.mountainproject.com/area/105920760/horse-flats',
...
for _, data in enumerate(accurate_data):
...
def save_json_zip(global_list):
    with open('hand_picked_2023.json', 'w', encoding='utf-8') as f:
